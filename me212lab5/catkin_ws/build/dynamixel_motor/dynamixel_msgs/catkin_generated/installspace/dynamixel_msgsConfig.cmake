...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/me212lab5/catkin_ws/install/${idir}'.  Ask the maintainer 'Antons Rebguns <arebgun@gmail.com>' to fix it.")
    endif()
